...
TELEGRAM_BOT_TOKEN = '6142588475:AAG5G9IM1TxnDCu9NKjRuhLatH2qOBPmNoY'
...
def start(update, context):
    message = """
👋 Welcome to the $Katan_Whale_Bot, For Monitoring Ethereum and Binance Wallets!
...
Don't forget to Buy $Katana Token if you find this bot useful!!!
    """
